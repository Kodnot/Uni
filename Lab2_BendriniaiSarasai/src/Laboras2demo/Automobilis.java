 ...
 * IŠSIAIŠKINKITE metodų sudarymą, jų paskirtį ir atitikimą KTUable. IŠBANDYKITE
 * jų veikimą, panaudojant klasę AutomobiliuBandymai. PASIRINKITE savo objektų
...
public class Automobilis implements KTUable<Automobilis> {
    ...
    public final static Comparator pagalMetusKainą = new Comparator() {
        ...
        public int compare(Object o1, Object o2) {
            ...
            if (a1.getGamMetai() < a2.getGamMetai()) {
                return 1;
            }
            if (a1.getGamMetai() > a2.getGamMetai()) {
                return -1;
