...
public class I_LokalesLietuvybe {

    /**
     * Demonstravimui reikalingiems metodams komentarai yra nuimami. Laikinai
     * nereikalingiems - komentarai yra uždedami.
     */
...
// -----------------------------------------------------------------------------
    ...
    /**
     * Išbandomas rūšiavimas su lietuviškais žodžiais (raidėmis), panaudojant
     * įvairias lokales.
     */
    void met1LietuviškiŽodžiai() {
        ...
        // Pasiruošiame sulyginimui pagal skirtingas kalbas
...
// -----------------------------------------------------------------------------
    ...
    /**
     * Išbandomas didelių skaičių vaizdavimas panaudojant triadas bei
     * dešimatainės dalies vaizdavimo valdymas. Tai yra bandomos išplėstinės
     * printf() galimybės.
     */
    void met2LokalizuotasSkaičiųPateikimas() {
...
// -----------------------------------------------------------------------------
     ...
     * panaudojant Scanner klasės objektus. Priklausomai nuo nustatytos lokalės
     * gali kilti klaidos situacija.
     */
    void met3LokalizuotasSkaičiųSkaitymas() {
...
// -----------------------------------------------------------------------------
     ...
     */
    public void met4GalimosLokalės() {
...
// -----------------------------------------------------------------------------
    ...
    public void met5() {
        ...
        System.out.printf(Locale.TAIWAN, "123456789asdfjkalks jh %d%d\n", 1, 10);
        System.out.println("Patikrinkite, ar tokių rezultatų tikėjotės ??\n");
    }
// -----------------------------------------------------------------------------

    public static void main(String[] args) {
        new I_LokalesLietuvybe().metodoParinkimas();
    }
}
